...
NCTfile[1,2]<-""
write.csv(NCTfile, "NC_ModifiedGenotypeFile.csvr", row.names = F) #CSVR file for input into ASMAP
#warnings()
#dim(NCTfile)[1]
rm(NCTfile)
rm(markers)
...
RumexNCTmap <- read.cross("csvr", ".", "NC_ModifiedGenotypeFile.csvr", crosstype = "f2",genotypes=c("A","H","B"), F.gen = 2)
